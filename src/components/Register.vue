<template>
    <section class="bg-light">
        ...
        <div id="contact-form" class="contact-form col-lg-12" style="margin:0px;width:100%;">
            <label class="col-lg-12"><b>Enter Your details </b></label>
            <br/>
            <br/>
         <form class="form col-lg-12" @submit="onSubmit">
             <span>
             ...
             <span>
                ...
                <button id="send" :disabled="btnDisabled" class="col-lg-6 button btn">Join US</button>
             </span>
         </form>
        </div>
        <br/>
        ...
        <div v-if="isAdmin">
            <p><b><a href="/showAllUsers" target="_blank"><u>Show All Registered Users </u></a> </b></p>
        </div>
    </section>
</template>
